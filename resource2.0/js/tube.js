		...
		if(typeof this._config.cableDistance == "undefined"){
  		...
  		if(typeof _subCables != "undefined"){
  			for(var i = 0 ; i < _subCables.length ; i ++){  		
  				...
  				_subCables[i].y = this._config.y + this._config.fiberDistance * this._config.fiberNumPerTube * _subCables[i].tubeNum * i + 10 * i;
  		 ...
  		 */
  		 ...
  		 /*
  		var _transNames = this._config.transNames;
  		if(typeof _transNames != "undefined" && _transNames != null && _transNames.length ){
  			console.log(" transName 传输业务编码 begin ....................");
  			for( var i = 0 ; i < _transNames.length ; i ++){
  				var transName = _transNames[i];
  				var cableId = transName.cableId;
  				var tubeIndex = transName.tubeIndex;
  				var fiberIndex = transName.fiberIndex;
  				if(cableId == this._config.cableId){
  				   	var key = cableId + "_" + tubeIndex;
  				   	var tube = this.tubesMap.get(key);
  				   //	tube._default_lines.get();
  				   console.log(tube.fibersCoordMap.size());

  				}else{
  					continue;
  				}
  			}
  			console.log(" transName 传输业务编码 end ....................");
  		}*/
